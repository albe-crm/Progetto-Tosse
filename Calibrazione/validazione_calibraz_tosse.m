...
% ---------------------------------------------------------
TH_ZCR = 0.002;         % Soglia ZCR
TH_ENERGY =40;      % Soglia Energia
TH_JERK = 0.11;        % Soglia Jerk (Scossa secca)
% ---------------------------------------------------------
...
ax3 = subplot(4,1,3);
plot(time, smooth_zcr, 'g'); yline(TH_ZCR, 'g--', 'LineWidth', 2);
title('ZCR'); grid on; legend('Segnale', 'Soglia');
